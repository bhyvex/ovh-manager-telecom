angular.module('managerApp').controller('XdslModemLanCtrl', function ($stateParams, $translate, OvhApiXdsl, PackXdslModemLanObject, validator, $q, Toast, TucPackXdslModemMediator) {
  const self = this;

angular.module('managerApp').service('TelecomMediator', function ($q, $translate, OvhApiMeVipStatus, TucPackMediator, TelephonyMediator, SmsMediator, FaxMediator, OverTheBoxMediator, Toast) {
  const self = this;
